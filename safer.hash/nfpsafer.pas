...
begin
	...
	writeln;
	writeln('Parameter   :  <SVUKON>  Safer MODE: VERBOSE UNKNOWN FILE ON');
	writeln('Parameter   :  <SVUKOFF> Safer MODE: VERBOSE UNKNOWN FILE OFF');
	writeln;
...
begin
	if ParamCount = 1 then begin
		...
		while true do begin
			...
			if ParamStr(1) = 'SVUKON' then begin NUMBER := PRINTK_UK_ON; break; end;
			if ParamStr(1) = 'SVUKOFF' then begin NUMBER := PRINTK_UK_OFF; break; end;
