...
(*
	...
	ALLOW/DENY List	: 2 DIM. dyn. char Array = string
			...
			: a:100;/usr/sbin		= all files in folder
	
			: d:100;/usr/sbin/test		= file
			: d:100;/usr/sbin		= all files in folder
	
			: ga:100;/usr/sbin/test		= file
			: ga:100;/usr/sbin/test2	= all files in folder
	
			: gd:100;/usr/sbin/test		= file
			: gd:100;/usr/sbin		= all files in folder file
